...
def create_app(test_config=None):
    ...
    def search_question():
        ...
        try:
            ...
            questions = Question.query.order_by(Question.id).filter(Question.question.ilike("%{}%".format(searchTerm))).all()
            ...
            return jsonify({
                ...
                'currentCategory': Category.query.get(searched_questions[-1]['category']).type
            })
        except:
            abort(404)
